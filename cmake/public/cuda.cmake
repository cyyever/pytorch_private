...
set_target_properties(
    ...
    INTERFACE_LINK_LIBRARIES CUDA::nvToolsExt)

# cublas
add_library(caffe2::cublas INTERFACE IMPORTED)
if(CAFFE2_STATIC_LINK_CUDA)
  set_property(
        TARGET caffe2::cublas PROPERTY INTERFACE_LINK_LIBRARIES CUDA::cublas_static)
else()
  set_property(
        TARGET caffe2::cublas PROPERTY INTERFACE_LINK_LIBRARIES CUDA::cublas)
endif()
...
if(CAFFE2_STATIC_LINK_CUDA)
  set_property(
        TARGET caffe2::cusparse PROPERTY INTERFACE_LINK_LIBRARIES CUDA::cusparse_static)
else()
  set_property(
        TARGET caffe2::cusparse PROPERTY INTERFACE_LINK_LIBRARIES CUDA::cusparse)
endif()
...
if(CAFFE2_STATIC_LINK_CUDA)
  set_property(
        TARGET caffe2::cusolver PROPERTY INTERFACE_LINK_LIBRARIES CUDA::cusolver_static)
else()
  set_property(
        TARGET caffe2::cusolver PROPERTY INTERFACE_LINK_LIBRARIES CUDA::cusolver)
endif()
...
if(CAFFE2_STATIC_LINK_CUDA)
    set_property(
        TARGET caffe2::curand PROPERTY INTERFACE_LINK_LIBRARIES CUDA::curand_static)
else()
    set_property(
        TARGET caffe2::curand PROPERTY INTERFACE_LINK_LIBRARIES CUDA::curand)
endif()
